...
class AIChatbot(commands.Cog):
    ...
    def __init__(self, client: commands.Bot, db_handler: DatabaseHandler):
        ...
        self.logger.info("[AIChatbot] AIChatbot cog initialized.")
...
async def setup(client: commands.Bot, db_handler: DatabaseHandler):
    ...
    :param db_handler: The DatabaseHandler instance.
    """
    logging.info("[AIChatbot] Setting up AIChatbot cog...")
    from config import OPENAI_API_KEY
    cog = AIChatbot(client, db_handler, OPENAI_API_KEY)
    await client.add_cog(cog)
    logging.info("[AIChatbot] AIChatbot cog successfully set up.")