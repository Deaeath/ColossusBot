...
class CommandsHandler(commands.Cog):
    ...
    @commands.command(name="clear_chat", help="Clears the conversation history for the user.")
    ...
    @commands.command(name="show_history", help="Displays the conversation history for a user.")
    ...
    @commands.command(name="reset_perms", help="Resets custom permissions for users and channels.")
    ...
    @commands.command(name="view_perms", help="Displays the current database records for custom permissions.")
    ...
    @commands.command(name="autoarchive", help="Automatically archives inactive channels.")
    ...
    @commands.command(name="archive", help="Archives a specific channel or category.")
    async def archive(
        self,
    ...
    @commands.command(name="unarchive", help="Unarchives a specific channel or category.")
    async def unarchive(
        self,
        ctx: commands.Context,
